/// Turkish provinces and their districts.
/// Names match Google Maps Geocoding API (language=tr) administrative_area_level_1/2.
class TurkeyLocations {
  static const Map<String, List<String>> districts = {
    ...
    'Antalya': ['Akseki','Aksu','Alanya','Demre','Döşemealtı','Elmalı','Finike','Gazipaşa','Gündoğmuş','İbradı','Kale','Kemer','Kepez','Konyaaltı','Korkuteli','Kumluca','Manavgat','Muratpaşa','Serik'],
    ...
    'Düzce': ['Akçakoca','Cumayeri','Çilimli','Düzce','Gümüşova','Gölyaka','Kaynaşlı','Yığılca'],
    ...
    'Erzurum': ['Aşkale','Aziziye','Çat','Hınıs','Horasan','İspir','Karayazı','Karaçoban','Narman','Oltu','Olur','Palandöken','Pasinler','Pazaryolu','Şenkaya','Tekman','Tortum','Uzundere','Yakutiye'],
    ...
    'Sivas': ['Altınyayla','Divriği','Doğanşar','Gemerek','Gölova','Hafik','İmranlı','Kangal','Koyulhisar','Merkez','Suşehri','Şarkışla','Ulaş','Yıldızeli','Zara'],
  ...
  static List<String> get cities => districts.keys.toList()..sort();
